...
export default function Register() {
    ...
    return (
      ...
      <form className="registerForm" onSubmit={handleSubmit}>
        ...
        <button className="registerLoginButton"><Link className="link" to="/login">Already have an account? Login Here.</Link></button>
    {error && <span style={{ margin: "10px", color: "red"}}>This username/email is already taken!</span>}
    </div>
    )
}